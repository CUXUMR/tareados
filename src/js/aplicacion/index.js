...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/tareados/API/aplicacion/guardar"
        const config = {
            method: 'POST',
            body
        }
...
const buscar = async () => {
    try {
        const url = "/tareados/API/aplicacion/buscar"
        const config = {
            method: 'GET',
        }
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = "/tareados/API/aplicacion/modificar"
        const config = {
            method: 'POST',
            body
        }
...
const eliminar = async (aplicacion) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/tareados/API/aplicacion/eliminar"
            const config = {
                method: 'POST',
                body
            }
