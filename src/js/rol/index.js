...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/laboratorio/API/rol/guardar"
        const config = {
            method: 'POST',
            body
        }
...
const buscar = async () => {
    try {
        const url = "/laboratorio/API/rol/buscar"
        const config = {
            method: 'GET',
        }
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = "/laboratorio/API/rol/modificar"
        const config = {
            method: 'POST',
            body
        }
...
const eliminar = async (rol) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/laboratorio/API/rol/eliminar"
            const config = {
                method: 'POST',
                body
            }
