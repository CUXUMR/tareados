...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/tareados/API/usuario/guardar"
        const config = {
            method: 'POST',
            body
        }
...
const buscar = async () => {
    try {
        const url = "/tareados/API/usuario/buscar"
        const config = {
            method: 'GET',
        }
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = "/tareados/API/usuario/modificar"
        const config = {
            method: 'POST',
            body
        }
...
const eliminar = async (usuario) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/tareados/API/usuario/eliminar"
            const config = {
                method: 'POST',
                body
            }
